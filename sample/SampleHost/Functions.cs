...
namespace SampleHost
{
    ...
    public class Functions
    {
        ...
        public static void Run1(
            [ServiceBusTrigger("tets-items-session", Connection = "AzureWebJobsServiceBus", IsSessionsEnabled=true)]
            string[] myQueueItem,
            ILogger log)
        {
        ...
        //    [EventHubTrigger("webjobstesthub", Connection = "AzureWebJobsEventHubReceiver")]
        //    string[] myQueueItem,
        //    ILogger log)
        //{
        //    log.LogInformation($"C# ServiceBus queue trigger function processed message: {myQueueItem}");
